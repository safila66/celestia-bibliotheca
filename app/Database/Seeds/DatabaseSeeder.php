...
class DatabaseSeeder extends Seeder
{
    public function run()
    {
        ...
        $books = [
            ...
            ['title'=>'Katalogisasi & Klasifikasi RDA',           'author'=>'Maryono',          'publisher'=>'UNS Press',      'year'=>2022,'isbn'=>'978-602-0001-02-2','call_number'=>'025.3 MAR k','category_id'=>$cats['ilmu-perpustakaan'], 'stock'=>2,'type'=>'buku','description'=>'Panduan praktis katalogisasi standar RDA.'],
