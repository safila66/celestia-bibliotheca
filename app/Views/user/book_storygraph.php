...
<div class="sg-container">
  <!-- LEFT COLUMN -->
  <div class="sg-left">
    <img src="/uploads/covers/<?= esc($book['cover_image'] ?? 'default-cover.jpg') ?>" class="sg-cover" alt="Cover" onerror="this.src='https://via.placeholder.com/320x480/1a1a2e/C9A84C?text=No+Cover'">
