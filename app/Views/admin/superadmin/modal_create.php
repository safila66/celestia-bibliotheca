<div class="modal-dialog modal-lg" style="width: 90%; max-width: 900px; height: 90vh; margin: auto; display: flex; flex-direction: column;">
    ...
    <div class="modal-content" style="background: #0a0f18; border: 2px solid #7ec8a0; border-radius: 8px; box-shadow: 0 20px 50px rgba(0,0,0,0.95); display: flex; flex-direction: column; height: 100%; overflow: hidden;">
        ...
        <div class="modal-header" style="flex-shrink: 0; border-bottom: 1px solid rgba(126,200,160,0.3); padding: 15px 25px; display: flex; justify-content: space-between; align-items: center;">
            <h5 class="modal-title" style="color: #7ec8a0; font-family: 'Cinzel', serif; margin: 0; font-size: 22px; font-weight: bold;">+ Tambah Admin Baru</h5>
        ...
        <form action="<?= base_url('admin/create/superadmin') ?>" method="post" enctype="multipart/form-data" style="display: flex; flex-direction: column; flex-grow: 1; overflow: hidden; margin: 0;">
            <?= csrf_field(); ?>
            ...
            <div class="modal-body" style="flex-grow: 1; overflow-y: auto; padding: 25px;">
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                    ...
                    <div class="form-group" style="grid-column: span 1;">
                        ...
                        <input type="text" name="name" required style="width: 100%; padding: 12px; font-size: 15px; background: #1a2332; border: 1px solid rgba(126,200,160,0.5); color: #ffffff !important; border-radius: 6px; box-sizing: border-box;">
                    </div>
                    ...
                    <div class="form-group" style="grid-column: span 1;">
                        ...
                        <input type="email" name="email" required style="width: 100%; padding: 12px; font-size: 15px; background: #1a2332; border: 1px solid rgba(126,200,160,0.5); color: #ffffff !important; border-radius: 6px; box-sizing: border-box;">
                    </div>
                    ...
                    <div class="form-group" style="grid-column: span 1;">
                        ...
                        <input type="password" name="password" required style="width: 100%; padding: 12px; font-size: 15px; background: #1a2332; border: 1px solid rgba(126,200,160,0.5); color: #ffffff !important; border-radius: 6px; box-sizing: border-box;">
                    </div>
                    ...
                    <div class="form-group" style="grid-column: span 1;">
                        ...
                        <input type="text" name="phone" style="width: 100%; padding: 12px; font-size: 15px; background: #1a2332; border: 1px solid rgba(126,200,160,0.5); color: #ffffff !important; border-radius: 6px; box-sizing: border-box;">
                    </div>
                    ...
                    <div class="form-group" style="grid-column: span 2;">
                        ...
                        <textarea name="address" rows="3" style="width: 100%; padding: 12px; font-size: 15px; line-height: 1.5; background: #1a2332; border: 1px solid rgba(126,200,160,0.5); color: #ffffff !important; border-radius: 6px; box-sizing: border-box;"></textarea>
                    </div>
                    
                    <div class="form-group" style="grid-column: span 2;">
                        <label style="color: #e2e8f0; font-size: 13px; font-weight: bold; letter-spacing: 0.05em; text-transform: uppercase; margin-bottom: 8px; display: block;">Foto Profil (Opsional)</label>
            ...
            <div class="modal-footer" style="flex-shrink: 0; border-top: 1px solid rgba(126,200,160,0.3); padding: 15px 25px; text-align: right; background: #070a11;">
                ...
                <button type="submit" style="background: #7ec8a0; color: #04060f; padding: 10px 20px; font-size: 14px; border: none; font-weight: bold; cursor: pointer; border-radius: 4px;">Simpan Admin</button>
            </div>
